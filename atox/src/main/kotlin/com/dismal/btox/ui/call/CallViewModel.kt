...
import com.dismal.btox.ProximityScreenOff
...
class CallViewModel @Inject constructor(
    ...
    fun startCall() {
        ...
        scope.launch {
            val contact = contactManager.get(publicKey).firstOrNull()
                ?: Contact(publicKey = publicKey.string(), name = publicKey.fingerprint())
